...
const I18N = {
    ...
    translations: {
        ...
        cat_burgers_msg: {
            es: 'Todas nuestras hamburguesas incluyen patatas fritas o boniato frito 🍟',
            en: 'All our burgers include french fries or sweet potato fries 🍟',
            de: 'Alle unsere Burger beinhalten Pommes frites oder Süßkartoffelpommes 🍟',
            fr: 'Tous nos burgers incluent des frites ou des frites de patate douce 🍟',
            sv: 'Alla våra hamburgare inkluderar pommes frites eller sötpotatisfries 🍟',
            da: 'Alle vores burgere inkluderer pommes frites eller sødekartoffelfritter 🍟',
            no: 'Alle våre burgere inkluderer pommes frites eller søtpotetfries 🍟',
            pt: 'Todos os nossos hambúrgueres incluem batatas fritas ou batatas doces fritas 🍟',
            it: 'Tutti i nostri hamburger includono patatine fritte o patatine fritte dolci 🍟',
            nl: 'Al onze burgers worden geserveerd met friet of zoete aardappelfriet 🍟',
            pl: 'Wszystkie nasze burgery zawierają frytki lub frytki z batatów 🍟',
            ru: 'Все наши бургеры идут с картофелем фри или бататом фри 🍟',
            zh: '我们所有的汉堡都包含炸薯条或炸红薯条 🍟',
            ja: 'すべてのハンバーガーにはフライドポテトまたはサツマイモフライが付いています 🍟',
            ko: '모든 버거에는 감자튀김 또는 고구마튀김이 포함되어 있습니다 🍟',
            ar: 'تشمل جميع أنواع البرغر لدينا بطاطس مقلية أو بطاطا حلوة مقلية 🍟',
        },
        cat_rolls: {
            es: 'Rolls Dog',
            en: 'Rolls Dog',
